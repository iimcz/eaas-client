const patchXpra = () => {
    ...
    XpraClient.prototype.init_state = new Proxy(
        XpraClient.prototype.init_state,
        {
            apply(target, thisArg, argArray) {
    ...
    XpraClient.prototype._keyb_process = new Proxy(
        XpraClient.prototype._keyb_process,
        {
            apply(target, thisArg, argArray) {
                ...
                if (
                    globalThis._eaasDoNotGrabKeyboardInFormElements &&
            ...
            apply(target, thisArg, argArray) {
                ...
                if (thisArg.clientGrabbed) {
                    ...
                    thisArg.send([
                        ...
                        [
                            movementX + RELATIVE_OFFSET,
                            movementY + RELATIVE_OFFSET,
                        ],
                        modifiers,
                        buttons,
                    ]);
    ...
    XpraClient.prototype.getMouse = new Proxy(XpraClient.prototype.getMouse, {
        apply(target, thisArg, argArray) {
            const ret = Reflect.apply(target, thisArg, argArray);
            if (
                !thisArg._clientGrabbedFirstClick &&
                thisArg.forceRelativeMouse
            ) {
